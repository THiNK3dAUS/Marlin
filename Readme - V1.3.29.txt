Thingiverse link - https://www.thingiverse.com/thing:4251390


Summary
Artillery Sidewinder TFT firmware G2 Beta v1.3.x. This is a beta release, alpha release will be 1.4.0 and will be the designation once it is established that everything is running smoothly. Let me know if you find any bugs. And check back for newer versions if you have a bug, I repair them quickly.
...
The M600 feature is brand new and not well tested - feedback is welcome.
The motor steps are adjustable through the TFT but the process is very annoying right now. It will be fixed soon.
*The bug fix for printing from the USB stick is not well tested. If you have problems and need to use USB for the time being, add 512 characters of comments to the beginning of your start code to make up for the sector that is being lost.
