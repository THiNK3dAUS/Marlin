 ...
 */
   ...
   */
  //#define PID_FAN_SCALING //fix look into this later
 ...
 *
 * Enable Autotemp Mode with M104/M109 F<factor> S<mintemp> B<maxtemp>. //fix look at later
 ...
 */
//#define USE_CONTROLLER_FAN //fix look into later
 ...
 */
//#define FAN_MIN_PWM 50  //fix look into later
...
#define DEFAULT_MINSEGMENTTIME        50000   // (µs) //fix debug 1.3.31 was 20000
...
//
//#define BACKLASH_COMPENSATION //fix disabled for stutter
...
#define LIN_ADVANCE
  ...
  #define EXPERIMENTAL_SCURVE // Enable this option to permit S-Curve Acceleration //fix check out later
#endif
...
#define MIN_STEPS_PER_SEGMENT 6 //fix revert to 6 and try s_curve //fix disabled for stutter
...
#define NO_TIMEOUTS 1000 // Milliseconds //fix ? //fix disabled for stutter was 0 from insanity
...
#define SERIAL_OVERRUN_PROTECTION //fix disable for stutter?
 ...
 */
   ...
   */
   //#define TMC_HOME_PHASE { 896, 896, 896 } //fix check this out later
...
#define M114_REALTIME       // Real current position based on forward kinematics //fix disabled for stutter 1.3.28
...
#ifdef G0_FEEDRATE
  #define VARIABLE_G0_FEEDRATE // The G0 feedrate is set by F in G0 motion mode //fix disabled for stutter
#endif
 ...
 */
//#define CANCEL_OBJECTS //fix look into later
